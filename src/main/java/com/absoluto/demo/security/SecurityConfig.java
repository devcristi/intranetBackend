...
//                                "/login"
//                        ).permitAll()
////                        .requestMatchers("/api/admin/**", "/api/centre/**", "/api/orar/**", "/api/trainer/**").hasRole("ADMIN")
//                                .requestMatchers("/api/orar/**", "/api/trainer/**", "/api/centre/**").hasAnyRole("USER", "TRAINER", "ADMIN")
//
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Permite accesul la endpoint-urile pentru orar, trainer și centre pentru utilizatori cu rolurile USER, TRAINER sau ADMIN
                        .requestMatchers("/api/orar/**", "/api/trainer/**", "/api/centre/**")
                        .hasAnyRole("STUDENT", "TRAINER", "ADMIN")
                        // Endpoint-urile pentru admin rămân restricționate doar pentru ADMIN
